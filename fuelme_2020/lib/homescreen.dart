...
import './fueltypes_draggable.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
                          ...
                          children: <Widget>[
                            Transform.translate(
                              ...
                              child:
                                ...
                                children: <Widget>[
                                  Transform.translate(
                                    offset: Offset(138.0, 167.0),
                                    child:
                                        // Adobe XD layer: 'map avatar' (component)
                                        Container(),
                                  ),
                                ],
                              ),
          ...
          // Adobe XD layer: 'Greetings and menu …' (shape)
          Container(
            width: 360.0,
            height: 139.0,
          ...
          Transform.translate(
            offset: Offset(20.95, 569.19),
            child:
                // Adobe XD layer: 'bottom' (group)
                Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(0.05, 0.81),
                  child:
                      // Adobe XD layer: 'bg' (group)
                      Stack(
                    children: <Widget>[
