      ...
      body: Container(
        ...
        decoration: BoxDecoration(
            ...
            Container(
              ...
              width: 60,
              decoration: BoxDecoration(
                image: DecorationImage(image: AssetImage('asset/Mainlogo.png'),
                    fit:BoxFit.fill
                ),
                ...
                Container(
                 ...
                 child: MaterialButton(
                   ...
                   shape: OutlineInputBorder(borderRadius: BorderRadius.circular(18.0),borderSide: const BorderSide(color: const Color(0))),
                 ),
                ),
                  Container(
                    height: 50,
